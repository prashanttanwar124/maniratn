            ...
            <div class="flex items-center justify-between border-b border-surface-200 pb-2">
                <div class="space-y-0.5">
                    <div class="flex items-center gap-1.5">
                        <PackagePlus class="w-4 h-4 text-[#c08f34]" />
                        <h4 class="font-bold text-xs text-surface-900 tracking-wide uppercase leading-none">Add Ornament to Stock</h4>
                    </div>
                    <p class="text-[10.5px] text-surface-500 font-medium pl-5.5">Review specs before saving barcode in ERP</p>
                </div>
