            ...
            <div class="-mx-4 -mt-4 flex items-center justify-between gap-3 border-b border-surface-200 bg-[#f8f6f0] px-3.5 py-2.5">
                <div class="flex items-center gap-2">
                    ...
                    <div class="flex flex-col justify-center">
                        <h4 class="text-xs font-semibold tracking-wide text-surface-900 leading-tight">Add ornament to stock</h4>
                        <p class="text-[10px] font-normal text-surface-500 leading-tight">Details verify karein, phir stock mein save karein</p>
                    </div>
                </div>
