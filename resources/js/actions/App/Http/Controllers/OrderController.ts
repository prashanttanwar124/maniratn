...
/**
* @see \App\Http\Controllers\OrderController::storeTransaction
* @see app/Http/Controllers/OrderController.php:0
* @route '/orders/{item}/transaction'
*/
export const storeTransaction = (args: { item: string | number } | [item: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/orders/{item}/transaction'
*/
storeTransaction.url = (args: { item: string | number } | [item: string | number ] | string | number, options?: RouteQueryOptions) => {
...
* @route '/orders/{item}/transaction'
*/
storeTransaction.post = (args: { item: string | number } | [item: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: storeTransaction.url(args, options),
    method: 'post',
})
...
* @route '/orders/{item}/transaction'
*/
const storeTransactionForm = (args: { item: string | number } | [item: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/orders/{item}/transaction'
*/
storeTransactionForm.post = (args: { item: string | number } | [item: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: storeTransaction.url(args, options),
    method: 'post',
})
...
/**
* @see \App\Http\Controllers\OrderController::addTransaction
* @see app/Http/Controllers/OrderController.php:136
* @route '/orders/{orderItem}/transaction'
*/
export const addTransaction = (args: { orderItem: number | { id: number } } | [orderItem: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
* @route '/orders/{orderItem}/transaction'
*/
addTransaction.url = (args: { orderItem: number | { id: number } } | [orderItem: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { orderItem: args }
    }
...
* @route '/orders/{orderItem}/transaction'
*/
addTransaction.post = (args: { orderItem: number | { id: number } } | [orderItem: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: addTransaction.url(args, options),
    method: 'post',
})
...
* @route '/orders/{orderItem}/transaction'
*/
const addTransactionForm = (args: { orderItem: number | { id: number } } | [orderItem: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
...
* @route '/orders/{orderItem}/transaction'
*/
addTransactionForm.post = (args: { orderItem: number | { id: number } } | [orderItem: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: addTransaction.url(args, options),
    method: 'post',
})
...
const OrderController = { storeTransaction, index, create, store, show, edit, update, destroy, assign, complete, deliver, addTransaction }
