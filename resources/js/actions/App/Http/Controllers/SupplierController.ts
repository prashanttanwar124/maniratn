...
* @see app/Http/Controllers/SupplierController.php:28
* @route '/suppliers'
*/
...
* @see app/Http/Controllers/SupplierController.php:70
...
* @see app/Http/Controllers/SupplierController.php:112
* @route '/suppliers/{supplier}'
*/
