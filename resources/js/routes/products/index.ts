...
/**
* @see \App\Http\Controllers\ProductController::print_barcodes
* @see app/Http/Controllers/ProductController.php:94
* @route '/products/print-barcodes'
*/
export const print_barcodes = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: print_barcodes.url(options),
    method: 'get',
})

print_barcodes.definition = {
    methods: ["get","head"],
...
* @route '/products/print-barcodes'
*/
print_barcodes.url = (options?: RouteQueryOptions) => {
    return print_barcodes.definition.url + queryParams(options)
}
...
* @route '/products/print-barcodes'
*/
print_barcodes.get = (options?: RouteQueryOptions): RouteDefinition<'get'> => ({
    url: print_barcodes.url(options),
    method: 'get',
})
...
* @route '/products/print-barcodes'
*/
print_barcodes.head = (options?: RouteQueryOptions): RouteDefinition<'head'> => ({
    url: print_barcodes.url(options),
    method: 'head',
})
...
* @route '/products/print-barcodes'
*/
const print_barcodesForm = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: print_barcodes.url(options),
    method: 'get',
})
...
* @route '/products/print-barcodes'
*/
print_barcodesForm.get = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: print_barcodes.url(options),
    method: 'get',
})
...
* @route '/products/print-barcodes'
*/
print_barcodesForm.head = (options?: RouteQueryOptions): RouteFormDefinition<'get'> => ({
    action: print_barcodes.url({
...
print_barcodes.form = print_barcodesForm
...
const products = {
    print_barcodes: Object.assign(print_barcodes, print_barcodes),
